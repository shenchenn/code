...
from Bisenetv1.batchnorm import SynchronizedBatchNorm2d
...
class Deeplabv3plus(nn.Module):
    def __init__(self, backbone, num_classes=3, freeze_bn=False):
        ...
        self.conv2 = nn.Conv2d(176, 48, 1, bias=False)
...
def Deeplabv3plus_shufflev2_15(num_classes=3):
    backone = ShuffleNetV2(stages_repeats=[4, 8, 4],
                             stages_out_channels=[24, 176, 352, 704, 1024],
                             num_classes=num_classes)

    model = Deeplabv3plus(backbone=backone, num_classes=num_classes, freeze_bn=False)
    return model

def Deeplabv3plus_shufflev2_1(num_classes=3):
    backone = ShuffleNetV2(stages_repeats=[4, 8, 4],
...
def Deeplabv3plus_shufflev2_05(num_classes=3):
    backone = ShuffleNetV2(stages_repeats=[4, 8, 4],
...
if __name__ == '__main__':
    model = Deeplabv3plus_shufflev2_15(num_classes=3, os=16, pretrained=False)
